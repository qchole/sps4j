...
import com.github.sps4j.common.utils.CallUtils;
 ...
 * It enforces parent-first loading for framework classes (under {@code com.github.sps4j}) and other
...
public class Sps4jPluginClassLoader extends URLClassLoader {
    private static final String FRAMEWORK_PACKAGE = "com.github.sps4j";
